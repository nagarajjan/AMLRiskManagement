...
from langchain_community.llms import Ollama # Import Ollama instead of OpenAI
import pandas as pd
...
def create_vector_store(data):
    # Note: Using OpenAIEmbeddings for the vector store is still fine.
    # The embeddings model is separate from the LLM used for generation.
...
if __name__ == '__main__':
    ...
    # Specify the model name you pulled (e.g., 'llama3')
